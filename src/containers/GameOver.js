    ...
    return (
      <div className={css(styles.container)}>
        ...
        <Twitter
          circle
          big
          message={`Yay, I scored ${this.props.score}!, Play tetris with words -:) #TetrisWithWord via @abvishek ${url}`}
          link={url}
        />
        ...
        <Whatsapp
          solidcircle
          big
          message={`Yay, I scored ${this.props.score}!, Play tetris with words -:) #TetrisWithWord`}
          link={url}
        />
      </div>
    );
